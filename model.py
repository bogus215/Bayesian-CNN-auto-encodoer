...
class Model(nn.Module):
    ...
    def __init__(self, args, **kwargs):  # pylint: disable=unused-argument
        ...
        # self.C = DenseCritic(args.latent_dim)
    ...
    def forward(self, x):
        ...
        y_5 = self.D.layers[:3](x_5)
        y_4 = self.D.layers[3][0](y_5 + x_4)
        y_3 = self.D.layers[3][1](y_4 + x_3)
        y_2 = self.D.layers[3][2](y_3 + x_2)
        y = self.D.layers[3][3](y_2 + x_1)
